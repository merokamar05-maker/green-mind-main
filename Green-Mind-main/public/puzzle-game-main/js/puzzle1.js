...
function setupGame(img) {
  ...
  // This drastically speeds up processing of 24MB+ images
  ...
  // Now that processing is 100% done, hide the loader
  hideLoading();
}
...
function displayVictoryStats() {
    ...
    // Star calculation (Level 1: 2x2 = 4 slots)
    ...
    // 3 stars: 100, 2 stars: 75, 1 star: 50
...
window.addEventListener("load", () => {
  ...
  const img = new Image();
  img.onload = () => {
    // Processing starts inside setupGame
    setupGame(img);
  };
